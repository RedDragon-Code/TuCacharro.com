...
> {
  ...
  constructor(
    @inject('datasources.CacharroDB') dataSource: CacharroDbDataSource, @repository.getter('PersonaRepository') protected personaRepositoryGetter: Getter<PersonaRepository>,
  ) {
